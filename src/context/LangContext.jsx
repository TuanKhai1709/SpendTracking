...
const translations = {
  en: {
    ...
    tagline: 'The best app for your financial plans',
    landingChooseLang: 'Please choose your language:',
    signUp: 'Sign up',
  ...
  vi: {
    ...
    tagline: 'Ứng dụng tốt nhất cho các kế hoạch tài chính của bạn',
    landingChooseLang: 'Vui lòng chọn ngôn ngữ:',
    signUp: 'Đăng ký',
